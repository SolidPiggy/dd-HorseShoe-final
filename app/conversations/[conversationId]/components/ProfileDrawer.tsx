                      ...
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="rounded-md bg-white text-gray-400 hover:text-orange-600 transition focus:outline-none focus:ring-2 focus:ring-orange-600 focus:ring-offset-2"
                              onClick={onClose}
                            >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            <div onClick={() => setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-75">
                              <div className="w-10 h-10 bg-neutral-900 rounded-full flex items-center justify-center text-orange-600">
                                <IoTrash size={20} />
                              </div>
